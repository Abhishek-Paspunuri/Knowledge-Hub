...
import { postQuestion } from '../redux/slice/questions';
    ...
    <>
      ...
      <div className={userStyles.userContainer}>
        ...
        <div className='d-flex justify-content-between'>
          ...
          {approvalStatus &&
            <button onClick={() => setShouldDisplayMyQuestion(!shouldDisplayMyQuestion)} className='btn btn-success' style={{ fontWeight: "600", marginLeft: "65%" }}>
